...
public sealed partial class StudioSetCommonEditorViewModel : ViewModelBase, IDisposable
{
    ...
    public void AdvancedStudioSet() => _navigateToRawTab?.Invoke("COMMON-STUDIO-SET");
    ...
    private ReactiveUI.Reactive.ReactiveCommand<Unit, Unit>? _advancedStudioSetCommand;
    public ReactiveUI.Reactive.ReactiveCommand<Unit, Unit> AdvancedStudioSetCommand =>
        _advancedStudioSetCommand ??= ReactiveCommand.Create(AdvancedStudioSet);
